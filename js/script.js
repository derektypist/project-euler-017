...
const SHORTSCALE = ['','thousand','million'];
...
function getNumberInfo() {
    ...
    if (isNaN(num) || num.toString().length == 0 || num < 1 || num>1000000 || !Number.isInteger(Number(num))) {
        txt += `Invalid Input.  Please enter a whole number between 1 and 1000000.`;
    } else {
